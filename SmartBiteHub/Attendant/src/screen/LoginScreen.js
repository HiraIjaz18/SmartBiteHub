...
import { View, Text, StyleSheet, ScrollView, TouchableOpacity, Alert, KeyboardAvoidingView, TextInput, Platform } from 'react-native';
...
const LoginScreen = ({ navigation }) => {
  ...
  const handleLogin = async () => {
    ...
    setLoading(true);
    try {
      const response = await fetch('http://192.168.100.6:4000/api/attendant/login', {
        method: 'POST',
