          ...
          <div style="padding: 12px;">
            <div class="receipt-container">
              ...
              <div class="thank-you">
                ...
                Your meal will be prepared fresh and delivered promptly.
              </div>
            </div>
          </div>
        </body>
        ...
        <View style={styles.receiptContainer}>
              ...
              <View key={index} style={styles.itemRow}>
                <View style={styles.itemInfo}>
                  ...
                  <Text style={styles.itemDetails}>
                    {item.quantity} × Rs{item.itemPrice?.toFixed(2) || '0.00'}
                  </Text>
                </View>
          ...
          <View style={styles.totalContainer}>
            ...
            <Text style={styles.totalAmount}>
              Rs{orderDetails.items.reduce((sum, item) => sum + ((item.itemPrice || 0) * item.quantity), 0).toFixed(2)}
            </Text>
          </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity
            ...
            onPress={() => navigation.navigate('CancelOrderScreen', {
              orderId: route.params.orderDetails.orderId,
              orderType: route.params.orderDetails.orderType 
            })}
          >
